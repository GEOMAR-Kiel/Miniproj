...
pub static IMPL_CONV: &[ImplementedProjection] = &[
    ...
    (
        9820,
        &lambert_azimuthal_equal_area::direct_projection,
    ),
    (9810, &stereographic::direct_projection_a),
    (
        9802,
        &lambert_conic_conformal::direct_projection_2sp,
    ),
    (
        1024,
        &popvis_pseudo_mercator::direct_projection,
    ),
    (
        9801,
        &lambert_conic_conformal::direct_projection_1sp_a,
    ),
    (
        9809,
        &stereographic::direct_projection_oblique,
    ),
